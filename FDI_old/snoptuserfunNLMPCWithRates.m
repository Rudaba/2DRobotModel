function [F,Jac,tout,yout,uout] = snoptuserfunNLMPCWithRates(x)
...
[Mayer,Integral,dC_dx]    = integralCost(y',u',v',psiDot',xRef,RR,RL,t);
...
F(1+n.*(N+1)+4) = y(1,4)- y0(4);
F(1+n.*(N+1)+5) = y(1,5)- y0(5);
