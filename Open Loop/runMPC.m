function runMPC(modelNumber,x,xlow,xupp,Flow,Fupp,iGfun,jGvar,fileName,plotResults)

global t0 tf Nu intdt M Nui y0 t_sort N m n
...
if modelNumber == 1
    ...
    if plotResults == 1
        processDSdata(x,y0,t0,tf,Nu,intdt,m)
    end
...
elseif modelNumber == 2
    ...
    if plotResults == 1
        processMSdata(x,y0,t0,tf,M,Nui,intdt,m,n)
    end
...
elseif modelNumber == 3
    ...
    if plotResults == 1
        processCollData(x,y0,t0,tf,N,intdt,m,n)
    end
...
elseif modelNumber == 4
    ...
    if plotResults == 1
         processPseudData(x,y0,t0,tf,t_sort,N,intdt,m,n)
    end
