...
elseif MPCmodelNumber == 3
    % Collocation
    [x,xlow,xupp,Flow,Fupp,iGfun,jGvar] = initialiseCollocation(y0,N,n,m,y0);
    
elseif MPCmodelNumber == 4
    % Pseudospectral
    [x,xlow,xupp,Flow,Fupp,iGfun,jGvar] = initialisePseudospectral(y0,N,n,m,y0);
...
runMPC(MPCmodelNumber,x,xlow,xupp,Flow,Fupp,iGfun,jGvar,'MS_Nui_10',plotResults);
